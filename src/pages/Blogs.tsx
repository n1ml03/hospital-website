                    ...
                    <div className="container-default w-container">
                        <div className="z-index-1">
                            <div className="mg-bottom-72px">
                                <div
                                    data-w-id="817a988e-efe4-fa24-64f0-8784c18a3fc1"
                                    className="w-layout-grid grid-2-columns title-and-search"
                                >
                                    ...
                                    <div className="inner-container _420px _100---tablet">
                                        <form action="/search" className="position-relative mg-bottom-0 w-form">
                                            <div className="position-relative">
                                                ...
                                                <div className="line-rounded-icon search-input default"></div>
                                            </div>
                            ...
                            <div
                                data-w-id="d14989f1-ccf1-1e0b-4055-decec9e2993c"
                                className="mg-bottom-32px w-dyn-list"
                            >
                                <div role="list" className="w-dyn-items">
                                    <div role="listitem" className="w-dyn-item">
                                        <a data-w-id="8bf90f25-30e3-fe98-3dff-a50170b11aa8" href="/blog/3-simple-and-easy-steps-to-jump-start-your-heart-health" className="card blog-v1-main-card w-inline-block">
