    ...
    return (
        <>
            <div className="section hero about">
                <div className="container-default w-container">
                    <div className="position-relative">
                            ...
                            <div className="z-index-1">
                                <div className="inner-container _1128px center">
                                    <div className="mg-bottom-64px">
                                        <div
                                            data-w-id="58ba26e0-65ef-722a-d8eb-8510ca9b9ee6"
                                    ...
                                    <div className="w-layout-grid grid-2-columns hero-grid-image">
                                        <img
                                            ...
                                            data-w-id="2e9cad6a-f5b1-a791-5fcd-12cc2565b9f9"
                                        ...
                                        <p
                                            ...
                                            data-w-id="4b8ebfb0-6469-b97a-1fb3-4b4a0ba8eb9b"
                                        ...
                                        <img
                                            ...
                                            data-w-id="2e9cad6a-f5b1-a791-5fcd-12cc2565b9fa"
                        ...
                        <div
                            data-w-id="2e9cad6a-f5b1-a791-5fcd-12cc2565b9fb"
                ...
                <div className="w-layout-blockcontainer container-default w-container">
                    ...
                    >
                        ...
                        <div
                            ...
                            data-w-id="ed5e1661-927a-b1c9-edd0-076335d16e9d"
                            className="text-center"
                        >
                        ...
                        <div
                            ...
                            data-w-id="ed5e1661-927a-b1c9-edd0-076335d16ea4"
                            className="text-center"
                        >
                        ...
                        <div
                            ...
                            data-w-id="ed5e1661-927a-b1c9-edd0-076335d16eab"
                            className="text-center"
                        >
                ...
                <div className="container-default w-container">
                    <div className="w-layout-grid grid-2-columns our-story-grid-2-col">
                        <div
                            ...
                            data-w-id="f735f34c-0afa-cb42-d815-19802d924d26"
                        ...
                        >
                            ...
                            <div data-w-id="f735f34c-0afa-cb42-d815-19802d924d39" className="blue-square _07">
                                <img src="images/646807f939eb0ae4c84ee3e2_shape-bg-our-professional.svg" alt="" className="image-shape _01" />
                            </div>
                        </div>
                        <div
                            id="w-node-_1d0a34a0-1560-b5b5-4d08-98dc5667e254-f7a60c9c"
                            data-w-id="1d0a34a0-1560-b5b5-4d08-98dc5667e254"
                        ...
                        >
                            ...
                            <a href="/doctors" className="btn-primary w-button"><span className="doctr-custom-icon btn-icon-left"></span>Meet our team</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="w-layout-grid grid-2-columns align-top gap-row-64px">
                        <div id="w-node-_91572671-f338-55c3-1505-840c0986be55-f7a60c9c" className="sticky-top _24px-top static-mbl">
                            <div
                                ...
                                data-w-id="89939ca2-2d90-2291-0140-2acfa666a101"
                        ...
                        <div
                            ...
                            data-w-id="86a0332b-f9da-6702-d1d1-4981283416a9"
            ...
            <div className="section overflow-hidden">
                <div className="container-default w-container">
                    <div
                        data-w-id="40dfb190-e4c2-56ee-45bb-9b34a5b05662"
                    ...
                    <div
                        data-w-id="f47433b5-666b-29e2-709e-439b1d0d772e"
                        className="mg-bottom-48px w-dyn-list"
                    >
                        <div role="list" className="grid-3-columns gap-row-32px _1-col-tablet w-dyn-items">
                            <div role="listitem" className="w-dyn-item">
                                <div className="card">
                                    <a data-w-id="f47433b5-666b-29e2-709e-439b1d0d7732" href="/doctors/dr-john-carter" className="display-block w-inline-block">
                                    ...
                                    <div className="card-description doctors-description">
                                        <a data-w-id="f47433b5-666b-29e2-709e-439b1d0d7738" href="/doctors/dr-john-carter" className="text-decoration-none w-inline-block">
                                        ...
                                        <div className="card-details-flex-container doctors-card-tag">
                                            <a href="/doctors/dr-john-carter" className="btn-circle-secondary doctor-btn-circle w-inline-block"><div></div></a>
                                            <a href="tel:(345)569-1189" className="btn-circle-secondary doctor-btn-circle w-inline-block"><div></div></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div role="listitem" className="w-dyn-item">
                                <div className="card">
                                    <a data-w-id="f47433b5-666b-29e2-709e-439b1d0d7732" href="/doctors/dr-sophie-moore" className="display-block w-inline-block">
                                        <div className="card-picture-wrapper">
                                            <img
                                    ...
                                    <div className="card-description doctors-description">
                                        <a data-w-id="f47433b5-666b-29e2-709e-439b1d0d7738" href="/doctors/dr-sophie-moore" className="text-decoration-none w-inline-block">
                                            <h3 className="card-title-dark heading-h4-size mg-bottom-4px">Dr. Sophie Moore</h3>
                                        </a>
                                        <p className="color-neutral-600 mg-bottom-24px">Lorem ipsum dolor sit amet consectetur nisl enim quam faucibus ut in id.</p>
                                        <div className="card-details-flex-container doctors-card-tag">
                                            <a href="/doctors/dr-sophie-moore" className="btn-circle-secondary doctor-btn-circle w-inline-block"><div></div></a>
                                            <a href="tel:(414)809-4504" className="btn-circle-secondary doctor-btn-circle w-inline-block"><div></div></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div role="listitem" className="w-dyn-item">
                                <div className="card">
                                    <a data-w-id="f47433b5-666b-29e2-709e-439b1d0d7732" href="/doctors/dr-matt-cannon" className="display-block w-inline-block">
                                        <div className="card-picture-wrapper">
                                            <img
                                    ...
                                    <div className="card-description doctors-description">
                                        <a data-w-id="f47433b5-666b-29e2-709e-439b1d0d7738" href="/doctors/dr-matt-cannon" className="text-decoration-none w-inline-block">
                                            <h3 className="card-title-dark heading-h4-size mg-bottom-4px">Dr. Matt Cannon</h3>
                                        </a>
                                        <p className="color-neutral-600 mg-bottom-24px">Lorem ipsum dolor sit amet consectetur nisl enim quam faucibus ut in id.</p>
                                        <div className="card-details-flex-container doctors-card-tag">
                                            <a href="/doctors/dr-matt-cannon" className="btn-circle-secondary doctor-btn-circle w-inline-block"><div></div></a>
                                            <a href="tel:(414)809-4504" className="btn-circle-secondary doctor-btn-circle w-inline-block"><div></div></a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div
                        data-w-id="c9e28a6e-568b-63fc-5c54-717d966c8880"
            ...
            <div className="border-radius-40px border-radius-16px-mbl overflow-hidden">
                <div className="section bg-neutral-200">
                    <div className="container-default w-container">
                        <div
                            data-w-id="f3c17a3c-53fa-4e40-0312-36c01048eec1"
                            className="inner-container _558px center"
                        >
                        ...
                        <div
                            data-w-id="689dcb3d-1cb9-034b-2602-b635987d9b65"
                            className="mg-bottom-48px w-dyn-list"
                        >
                            <div role="list" className="grid-2-columns hospital-grid-card v1 w-dyn-items">
                                <div id="w-node-_689dcb3d-1cb9-034b-2602-b635987d9b67-f7a60c9c" role="listitem" className="flex w-dyn-item">
                                    <div className="card hospital-location-card v1">
                                        <a data-w-id="689dcb3d-1cb9-034b-2602-b635987d9b69" href="/hospital/san-francisco-ca" className="card-picture-wrapper hospital-card-picture v1 w-inline-block">
                                            <img
                                        ...
                                        <div className="card-description hospital-card-description v2">
                                            <a data-w-id="689dcb3d-1cb9-034b-2602-b635987d9b6c" href="/hospital/san-francisco-ca" className="text-decoration-none w-inline-block"><h3 className="card-title-dark display-4">San Francisco, CA</h3></a>
                                            ...
                                            <div className="w-layout-grid grid-3-columns info-grid-3-col v2">
                                                <div id="w-node-_689dcb3d-1cb9-034b-2602-b635987d9b73-f7a60c9c">
                                                    ...
                                                    <a data-w-id="689dcb3d-1cb9-034b-2602-b635987d9b77" href="tel:(253)456-1189" className="card-link color-neutral-600 w-inline-block"><div className="link-text">(253) 456 - 1189</div></a>
                                                </div>
                                                ...
                                                <div id="w-node-_689dcb3d-1cb9-034b-2602-b635987d9b7a-f7a60c9c">
                                                    <div>
                                                        ...
                                                        <a data-w-id="689dcb3d-1cb9-034b-2602-b635987d9b7f" href="mailto:sanfrancisco@doctr.com" className="card-link color-neutral-600 w-inline-block">
                                ...
                                <div id="w-node-_689dcb3d-1cb9-034b-2602-b635987d9b67-f7a60c9c" role="listitem" className="flex w-dyn-item">
                                    <div className="card hospital-location-card v1">
                                        <a data-w-id="689dcb3d-1cb9-034b-2602-b635987d9b69" href="/hospital/mountain-view-ca" className="card-picture-wrapper hospital-card-picture v1 w-inline-block">
                                            <img
                                        ...
                                        <div className="card-description hospital-card-description v2">
                                            <a data-w-id="689dcb3d-1cb9-034b-2602-b635987d9b6c" href="/hospital/mountain-view-ca" className="text-decoration-none w-inline-block"><h3 className="card-title-dark display-4">Mountain View, CA</h3></a>
                                            <p className="color-neutral-600 mg-bottom-24px">Lorem ipsum dolor sit amet consectetur commodo aliquam augue duis aliquet ipsum donec tempus ac interdum enim.</p>
                                            <div className="w-layout-grid grid-3-columns info-grid-3-col v2">
                                                <div id="w-node-_689dcb3d-1cb9-034b-2602-b635987d9b73-f7a60c9c">
                                                    <div className="mg-bottom-12px mg-bottom-6px-mbl"><div className="text-200 medium color-neutral-600">Phone number</div></div>
                                                ...
                                                <div id="w-node-_689dcb3d-1cb9-034b-2602-b635987d9b7a-f7a60c9c">
                                                    <div>
                                                        <div className="mg-bottom-12px mg-bottom-6px-mbl"><div className="text-200 medium color-neutral-600">Email address</div></div>
                                                        <a data-w-id="689dcb3d-1cb9-034b-2602-b635987d9b7f" href="mailto:mountainview@doctr.com" className="card-link color-neutral-600 w-inline-block">
                    ...
                    <div className="w-layout-grid grid-2-columns grid-faqs">
                        <div id="w-node-_35ad3736-35eb-c979-bece-4ee3a18e6c79-f7a60c9c" className="sticky-top _24px-top static-mbl">
                            <div
                                ...
                                data-w-id="35ad3736-35eb-c979-bece-4ee3a18e6c7a"
                        ...
                        <div
                            id="w-node-_35ad3736-35eb-c979-bece-4ee3a18e6c85-f7a60c9c"
                            data-w-id="35ad3736-35eb-c979-bece-4ee3a18e6c85"
                        >
                            <div data-w-id="a83e6a72-3d3f-0f42-5cff-242e7ea90b8a" className="accordion-item-wrapper v2 first">
                            ...
                            <div data-w-id="094fffe5-5039-b0a3-f43d-ae901913ba98" className="accordion-item-wrapper v2">
                                <div className="accordion-image-left-wrapper">
                                    <div className="accordion-content-wrapper v2">
                                        <div className="accordion-header icon-inside">
                            ...
                            <div data-w-id="b3d8da89-5cb4-3b47-dc56-97931af5fcfa" className="accordion-item-wrapper v2">
                                <div className="accordion-image-left-wrapper">
                                    <div className="accordion-content-wrapper v2">
                                        <div className="accordion-header icon-inside">
                            ...
                            <div data-w-id="0dcfa5f7-b340-9b94-9a16-b43a67d9cd76" className="accordion-item-wrapper v2 last">
                                <div className="accordion-image-left-wrapper">
                                    <div className="accordion-content-wrapper v2">
                                        <div className="accordion-header icon-inside">
