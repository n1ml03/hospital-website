                ...
                <div className="container-default w-container">
                    ...
                    <div className="w-layout-grid grid-3-columns booking-grid-3-col">
                            <div
                                ...
                                data-w-id="08e9d63a-aa6b-fe17-6540-ffee451f3662"
                            ...
                            <div
                                ...
                                data-w-id="08e9d63a-aa6b-fe17-6540-ffee451f3669"
                                className="inner-container _330px _100-tablet"
                            >
                                <div className="mg-bottom-24px">
                                    <div className="image-wrapper size-80px">
                                        <img src="src/icons/contact-visit-us-icon.svg" alt="Contact Visit Us Icon" className="circle-icon" />
                                    </div>
                                </div>
                                ...
                                <a data-w-id="08e9d63a-aa6b-fe17-6540-ffee451f3671" href="https://www.google.com/maps" target="_blank" className="card-link color-neutral-600 blue w-inline-block">
                            ...
                            <div
                                ...
                                data-w-id="08e9d63a-aa6b-fe17-6540-ffee451f367c"
                                className="inner-container _196px _100-tablet"
                            >
                                <div className="mg-bottom-24px">
                                    <div className="image-wrapper size-80px">
                                        <img src="src/icons/contact-phone-icon.svg" alt="Contact Phone Icon" className="circle-icon" />
                                    </div>
                                </div>
